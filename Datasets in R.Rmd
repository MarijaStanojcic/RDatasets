...
rdatasets_new <- rdatasets[c(1:16,18:1243),] # taking everything exept cd4.nested

rdatasets_new$Item <- as.character(rdatasets_new$Item)
rdatasets_new$Item[1075] <- "InfantMortality2010"     # "InfantMortality" is in the 1076 row
rdatasets_new$Item[1079] <- "Leafhoppers"     

rdatasets_new$Title <- as.character(rdatasets_new$Title)
rdatasets_new$Title[1075] <- "Infant Mortality Rates"
rdatasets_new$Title[1079] <- "Leafhopper Diet and Longevity"   

rdatasets_new$Rows[1075] <- 10
rdatasets_new$Rows[1079] <- 3
...
```{r}
# write.csv(rdatasets_new, file = "Rdatas")
```
